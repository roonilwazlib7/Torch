...
# TODO:
# Alert user of successful/errored imports/exports
# Data might be exporting twice
...
class MapMaker
    ...
    GetMapPieceImageUrl: (mapPiece) ->
        ...
        url = "../Assets/Art/#{subFolder + mapPiece::textureId}.png"
        return url
